...
G1 H1 X-405 Y405 U-405 F3000 		; move quickly to X and Y axis endstops and stop there (first pass)
G1 H2 X5 Y-5 U5 F600      		; go back a few mm
G1 H1 X-405 Y405 U-405 F600  		; move slowly to X and Y axis endstops once more (second pass)
