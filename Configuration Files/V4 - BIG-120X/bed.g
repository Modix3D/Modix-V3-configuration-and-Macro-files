...
while true
	...
	M280 P0 S60 I1																													; clear any probe errors
	G30 P1 X{move.axes[0].max + sensors.probes[0].offsets[0] - 8} Y{move.axes[1].min + sensors.probes[0].offsets[1] + 2} Z-99999	; Probe near front right leadscrew
	M280 P0 S60 I1																													; clear any probe errors
	G30 P2 X{move.axes[0].max + sensors.probes[0].offsets[0] - 8} Y{move.axes[1].max + sensors.probes[0].offsets[1] - 2} Z-99999	; Probe near rear right leadscrew
	M280 P0 S60 I1																													; clear any probe errors
