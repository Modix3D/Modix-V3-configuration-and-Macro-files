...
M913 X50 U50
G1 H1 X-1205 U-1205 F3000 				; move quickly to X axis endstop and stop there (first pass)
G1 H2 X5 U5 F600    					; go back a few mm
G1 H1 X-1205 U-1205 F600  				; move slowly to X axis endstop once more (second pass)
M400
