...
if !move.axes[0].homed || !move.axes[1].homed || !move.axes[2].homed	; If the printer hasn't been homed, home it
	...
	G1 H2 X5 Y-5 F600      											M291 S3 R"Tilt calibration" P"Press OK to continue, or CANCEL to abort"
...
M291 S2 R"Tilt calibration has been completed" P"You may proceed to the next step"	; go back a few mm
