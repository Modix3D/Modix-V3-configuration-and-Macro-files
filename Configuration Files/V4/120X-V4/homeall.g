...
G1 H1 X{(move.axes[0].max+5)*-1} Y{(move.axes[1].max+5)} F8000  	; move quickly to X and Y axis endstops and stop there (first pass)
...
G1 X{move.axes[0].min+5} Y{move.axes[1].min+5} F8000 				; move to front left
